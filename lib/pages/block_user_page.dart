...
//     return Scaffold(appBar: AppBar(title: const Text('Block User')), body: const Center(child: Text('Block User - Interface Only')));
//   }
// }
...
//             child: Text('Block User - Interface Only', style: TextStyle(fontSize: 18)),
//           ),
//         ),
//       ),
//     );
...
//     return Scaffold(
//       appBar: AppBar(title: const Text("Block/Unblock Users")),
